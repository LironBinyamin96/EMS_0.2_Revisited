...
//        #endregion
//        #region Employee Propperties
//        public int IntId => _intId;
//        public Type Type { get => _type; }
//        public int IntId1 => _intId;
...
//            _employeeDir = new EmployeeDirectory(_intId);
//        }
//        public Employee(object[] data)
//        {
//            string[] hold = Array.ConvertAll(data, x => x.ToString());
//            _type = Type.GetType("EMSLibrary.MyEmployee.Divisions." + data[0]);
...
//                temp += item.Trim() + ",";
//            try { return Activator.CreateInstance(Type.GetType("EMSLibrary.MyEmployee.Divisions." + hold[0]), temp.Trim()) as Employee; }
//            catch { return null; }
//        }
